...
class LDPC_Decoder_Test(unittest.TestCase):
    ...
    #1 Bit Errors
    test_0 = Positive_Test(0b0000,0b000001000)
    test_1 = Positive_Test(0b0001,0b000111101)
    test_2 = Positive_Test(0b0010,0b001001001)
    test_3 = Positive_Test(0b0011,0b001111100)
    test_4 = Positive_Test(0b0100,0b010010010)
    test_5 = Positive_Test(0b0101,0b010100111)
    test_6 = Positive_Test(0b0110,0b011010011)
    test_7 = Positive_Test(0b0111,0b011100110)
    test_8 = Positive_Test(0b1000,0b100001010)
    test_9 = Positive_Test(0b1001,0b100111111)
    test_10 = Positive_Test(0b1010,0b101010011)
    test_11 = Positive_Test(0b1011,0b101100110)
    test_12 = Positive_Test(0b1100,0b110001000)
    test_13 = Positive_Test(0b1101,0b110111101)
    test_14 = Positive_Test(0b1110,0b111001001)
    test_15 = Positive_Test(0b1111,0b111111100)